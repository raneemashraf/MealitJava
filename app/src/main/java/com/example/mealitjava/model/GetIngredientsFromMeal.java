...
public class GetIngredientsFromMeal {


    public static ArrayList<Ingredient> getArrayList(MealsItem meal) {
        ArrayList<Ingredient> list = new ArrayList<>();
        makeArrayFromMeal(meal, list);
        return list;
    }

    private static void makeArrayFromMeal(MealsItem meal, ArrayList<Ingredient> list) {
    ...
    private static void addToArray(String strIngredient, String strMeasure, ArrayList<Ingredient> list) {
        if (strIngredient != null && !strIngredient.isEmpty()) {
            ...
            list.add(new Ingredient(strIngredient, measure));
        }
    }
